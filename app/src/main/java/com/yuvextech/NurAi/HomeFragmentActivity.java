...
public class HomeFragmentActivity extends Fragment {
	...
	private ViewPager viewpagerSlider1;
	...
	private void initialize(Bundle _savedInstanceState, View _view) {
		...
		viewpagerSlider1 = _view.findViewById(R.id.viewpagerSlider1);
		...
		btnShareWisdom.setOnClickListener(new View.OnClickListener() {
			@Override
		...
		btnAskAiWisdom.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
	...
	public void _Ui() {
		...
		final float scaleFactor = 0.90f;
		viewpagerSlider1.setPageMargin(-30);
		viewpagerSlider1.setOffscreenPageLimit(2);
		viewpagerSlider1.setPageTransformer(false, new ViewPager.PageTransformer() {
			@Override
		...
		viewpagerSlider1.setAdapter(new ViewpagerSlider1Adapter(listmap));
		...
		seven = new TimerTask() {
			...
			public void run() {
				getActivity().runOnUiThread(new Runnable() {
					@Override
					public void run() {
						viewpagerSlider1.setCurrentItem((int)num);
						num++;
						if (num == listmap.size()) {
							num = 0;
						}
	...
	public class ViewpagerSlider1Adapter extends PagerAdapter {
		
		Context _context;
		ArrayList<HashMap<String, Object>> _data;
		
		public ViewpagerSlider1Adapter(Context _ctx, ArrayList<HashMap<String, Object>> _arr) {
			_context = _ctx;
			_data = _arr;
		}
		
		public ViewpagerSlider1Adapter(ArrayList<HashMap<String, Object>> _arr) {
		...
		public Object instantiateItem(ViewGroup _container,  final int _position) {
			...
			cardview1.setRadius((int)25);
			cardview1.setCardElevation((float)5);
			cardview1.setBackground(new GradientDrawable() { public GradientDrawable getIns(int a, int b, int c) { this.setStroke(a, b); this.setColor(c); return this; } }.getIns((int)1, getResources().getColor(R.color.card_stroke), getResources().getColor(R.color.backgroundColor)));
